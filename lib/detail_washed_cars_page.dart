              ...
              children: [
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: car.carPhoto != null && car.carPhoto!.isNotEmpty
                            ? NetworkImage(car
                            .carPhoto!) // Используем NetworkImage для загрузки изображения
                            : AssetImage(
                ...
                Text(
                  car.orderDate != null
                      ...
                      DateTime.parse(car.orderDate!))
                      : 'Неизвестно',
                  style: TextStyle(fontSize: 18),
                ),
                Divider(),
                Text('Вид мойки', style: TextStyle(
                    fontSize: 16, fontWeight: FontWeight.bold)),
